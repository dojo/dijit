...
dojo.declare(
	...
	null,
	{
		...
		frontPercentClass: "dojoProgressBarFrontPercent",

		// backPercentClass: String
		// css class for backPercentLabel (2)
		backPercentClass: "dojoProgressBarBackPercent",

		// frontBarClass: String
		// css class for containerNode (1)
		frontBarClass: "dojoProgressBarFrontBar",

		// backBarClass: String
		// css class for internalProgress (3)
		backBarClass: "dojoProgressBarBackBar",
