...
dojo.declare("dijit._editor.plugins.LinkDialog",
	dijit._editor._Plugin,
	{
		...
		linkDialogTemplate: [
			...
			"</td><td>",
			"<input dojoType='dijit.form.ValidationTextBox' regExp='${urlRegExp}' required='true' name='urlInput'>",
			"</td></tr><tr><td>",
			"<label for='textInput'>${text}</label>",
			"</td><td>",
			"<input dojoType='dijit.form.ValidationTextBox' required='true' name='textInput'>",
